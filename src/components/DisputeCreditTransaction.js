            ...
            <div>
                ...
                <div class="form-inline">
                    <div class="form-group col-sm-2">
                        <button name="confirm" type="button" class="btn btn-primary btn-sm" onClick={this.props.handleConfirmbt} >Yes - This is correct</button>
                    </div>
                    <div class="form-group col-sm-2">
                        <button name="cancel" type="button" class="btn btn-primary btn-sm" onClick={this.props.handleConfirmbt} >No -Cancel</button>
                    </div>
                </div>
            </div>
        );
