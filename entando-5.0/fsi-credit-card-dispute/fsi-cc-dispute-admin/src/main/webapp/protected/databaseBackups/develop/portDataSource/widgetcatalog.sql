...
INSERT INTO widgetcatalog (code,titles,parameters,plugincode,parenttypecode,defaultconfig,locked,maingroup) VALUES ('fsi-credit-card-dispute-customer','<?xml version="1.0" encoding="UTF-8"?>
<properties><property key="en">fsi-credit-card-dispute-admin</property><property key="it">fsi-credit-card-dispute-admin</property></properties>
